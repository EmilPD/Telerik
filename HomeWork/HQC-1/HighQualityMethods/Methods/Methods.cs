namespace Methods
{
    ...
    public class Methods
    {
        public static void Main()
        {
            ...
            Console.WriteLine(CalcDistance(firstPointX, firstPointY, secondPointX, secondPointY));
        ...
        public static double CalcTriangleArea(double a, double b, double c)
        {
            ...
            if (!isValid)
            {
                throw new ArgumentException("Triangle sides");
            }
        ...
        public static string NumberToDigit(int digit)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("Is not digit!");
            }
        }
        ...
        public static int FindMax(params int[] elements)
        {
            ...
            {
                throw new ArgumentException("Array of elements");
            }
        ...
        public static void PrintAsNumber(object number, OutoutFormatType format)
        {
            switch (format)
            {
        ...
        private static bool IsValidTriangle(double a, double b, double c)
        {
            if (a <= 0 || b <= 0 || c <= 0)
            {
                throw new ArgumentOutOfRangeException("Triangle side");
            }
